...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Create([FromBody]CelestialObject celestialOjbect)
        {
            _context.CelestialObjects.Add(celestialOjbect);
            _context.SaveChanges();

            return CreatedAtRoute("GetById", new { id =  celestialOjbect.Id }, celestialOjbect);
        }
